...
def scope_rows() -> list[dict[str, str]]:
    return [
        ...
        {"feature": "P9.3.2d", "theoretical paper": "AN19 static LSST prerequisite for Lemma 5.4", "current Rust artifact": "Faithful implementation complete", "tested": "exact Oracle differential and trace audit", "notes": "proof debt is deferred until P9.6; P9.3.3 through P9.5 may proceed, but no AN19 runtime claim is permitted"},
        {"feature": "almost-linear theoretical flow backend", "theoretical paper": "used asymptotically", "current Rust artifact": "P9.5 implementation pending", "tested": "no", "notes": "the source-shaped semantic chain may proceed; the AlmostLinear claim awaits P9.6 proof closure"},
