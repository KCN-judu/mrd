...
def scope_rows() -> list[dict[str, str]]:
    return [
        ...
        {"feature": "AN19 reduced-event conversion lemma", "theoretical paper": "required for the local P9.3.2d runtime chain", "current Rust artifact": "Blocked / not found in cited source", "tested": "not provable by finite tests", "notes": "must bound and order equivalence classes of ell(u,v) + d(x,u) - d(x,v)"},
