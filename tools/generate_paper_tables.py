...
def scope_rows() -> list[dict[str, str]]:
    return [
        ...
        {"feature": "AN19 exact reduced-event ordering replacement", "theoretical paper": "required for the local P9.3.2d runtime chain", "current Rust artifact": "Blocked / not found in cited source", "tested": "not provable by finite tests", "notes": "must order de-potentialized exact rational thresholds without one priority class per reduced cost"},
