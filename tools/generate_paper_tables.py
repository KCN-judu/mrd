...
def scope_rows() -> list[dict[str, str]]:
    return [
        ...
        {"feature": "AN19 exact reduced-event ordering replacement", "theoretical paper": "required for the local P9.3.2d runtime chain", "current Rust artifact": "Implemented semantics / proof blocked", "tested": "bounded exact differential only", "notes": "the proved backend must bound de-potentialized exact rational thresholds without one priority class per reduced cost"},
        {"feature": "AN19 runtime verification", "theoretical paper": "O(m log n log log n)", "current Rust artifact": "Blocked", "tested": "no", "notes": "workspace scans do not close the missing mathematical reduction"},
        {"feature": "P9.3.2d", "theoretical paper": "AN19 static LSST prerequisite for Lemma 5.4", "current Rust artifact": "Hard blocker", "tested": "implementation side only", "notes": "dependent P9 phases are not started and forbidden until resolved"},
        {"feature": "almost-linear theoretical flow backend", "theoretical paper": "used asymptotically", "current Rust artifact": "not implemented", "tested": "no", "notes": "citation-only complexity component; blocked downstream of P9.3.2d"},
