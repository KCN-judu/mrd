...
pub use formal_polygon::{
    ...
    FormalDirection, FormalFamilies, FormalInnerAngle, FormalPolygonError, FormalQuadrant,
    FormalRectilinearPolygon, FormalVertex, FormalVertexGeometry, FormalVertexId, Ornament,
    OrnamentSegment,
};
