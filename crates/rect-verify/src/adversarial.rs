...
mod tests {
    ...
    fn geometry_families_cover_path_and_branching_witnesses() {
        ...
        for instance in families {
            ...
            for orientation in [
                rect_dominance::PathTreeOrientationPolicy::VerticalTree,
                rect_dominance::PathTreeOrientationPolicy::HorizontalTree,
            ] {
                let partition =
                    rect_dominance::path_tree::build_path_tree_partition_with_orientation_policy(
                        &geometry.prepared,
                        &geometry.boundary,
                        &geometry.horizontal_chords,
                        &geometry.vertical_chords,
