...
use mrd_domain::{
    FormalFamilies, FormalPolygonError, FormalRectilinearPolygon, HorizontalChord, VerticalChord,
...
use sg_oracle::polygon::{PolygonCompletionResult, PolygonSgError};
...
pub fn analyze_formal_admissible_family(
    ...
    let families = mrd_domain::formal_polygon::experiment::effective_chords(polygon)?.families;
...
pub fn complete_formal_polygon(
    ...
    let completion = sg_oracle::polygon::CoordinateCompressedCompletion.complete_formal(
        polygon,
...
impl FormalStep2Transformation {
    fn new(families: &FormalFamilies) -> Result<Self, FormalAdmissibleError> {
