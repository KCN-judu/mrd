...
| Definitions 5.6--5.8, Theorem 5.1 | d-level tree chain, shifted single branch, compact cycle representation, hidden-stability data structure | `rect-graph::dynamic_min_ratio` | P8.5 exact compact-cycle decode, P7 conservation comparison, deterministic shift/rebuild, and P8.1 replay tests; no Theorem 5.1 query or bound claim |
