...
| Lemma 5.5 | Deterministic multiplicative-weights collection of low-stretch forests | `graph::lsf_mwu` | P8.4 deterministic exact reweighting baseline: weighted Kruskal candidates, per-edge average-stretch certificates, and deterministic-order tests; no Lemma 5.5 bound claim |
