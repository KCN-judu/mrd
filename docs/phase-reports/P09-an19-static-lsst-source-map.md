...
| `cargo test -p rect-graph --lib` | 0 | 100 tests passed; fixed-path reuse preserves all hierarchy, contraction, recovery, and source-counter certificates |
