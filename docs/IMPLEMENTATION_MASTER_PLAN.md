...
- Last pushed SHA: cb59512bf9ff27cc7323cfdad5831cda1355635c
- Plan last updated: 2026-07-28T23:49:52Z
...
| P9.3.2d-practical-pq-bound | complete | ebde003 | 02c8385, fbc869e, bbf13b3 | pending | pending | `docs/AN19_LOCAL_EVENT_BOUND.md`; `docs/phase-reports/P09-an19-static-lsst-source-map.md` | exact stable binary heap and machine-verified `3 I ceil(log2(max(I,1))) + 2m` practical comparison bound in all 31 reduced A--H runs; Oracle independence retained; 256 passed and 3 existing ignored | 2026-07-28T23:59:57Z | 2026-07-29T00:14:09Z | source-equivalent PQ proof, global amortization, runtime, and P9.3.3-P12 remain blocked |
