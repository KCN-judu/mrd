...
- Last pushed SHA: 88a89b2c28ef3872bc32c3d0cd0d9d98d97c2eeb
- Plan last updated: 2026-07-28T18:18:51Z
...
2. **P9.3.2 state: blocked. Start SHA: `6e96916`; implementation SHAs:
   ...
   - **P9.3.2d state: blocked. Hard blocker. Implementation SHAs: `3bb0400`, `839cb5c`,
     ...
     **Exact proof obligation:** the `O(log n)` reduced-class route is refuted
...
| P9.3.2d-event-engine | blocked | 89b5ea3 | 7ea13da, 28f9ff7, 6c8cfac, 98bb615, afea347, 4413e94 | pending | pending | `docs/phase-reports/P09-an19-static-lsst-source-map.md` | exact Oracle/reduced engine, canonical trace, six charge maps, A--H campaign, CLI, manifest and full audit; 254 passed and 3 existing ignored | 2026-07-28T17:29:46Z | pending | local/global/PQ event proofs and AN19 runtime remain blocked; P9.3.3-P12 remain forbidden |
