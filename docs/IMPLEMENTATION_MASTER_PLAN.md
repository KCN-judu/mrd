...
- Plan last updated: 2026-08-03T11:56:48Z
...
- **P11.1 - Backend contract and counters. State: complete.** Define the
...
- **P11.2 - Exact direct parity encoder. State: complete.** Implement the four
  checked formulas for finite integer grid chords, with no rank sets, maps, or
  sorted coordinate vectors in the direct branch.
- **P11.3 - Grid pipeline integration. State: complete.** Route the grid
...
- **P11.5 - Release evidence and performance boundary. State: in_progress.** Add
...
| P11 | in_progress | 06a030d | 8cadec8, ab95125, 7ea43cd | pending | pending | `docs/phase-reports/P11-direct-grid-parity.md` | direct grid parity embedding with RankedCoordinates as the permanent Oracle | 2026-08-03T10:58:31Z | pending | direct formula and counters complete; P11.3-P11.4 checkpoints are pushed; P11.5 remains |
...
| P11.5 | in_progress | 7ea43cd | pending | pending | pending | pending | direct-vs-ranked release evidence and performance boundary | 2026-08-03T11:56:48Z | pending | direct-specific evidence must not reuse polygon-derived timing; structural counters are measured, but no end-to-end speed claim exists yet |
